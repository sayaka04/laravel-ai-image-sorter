...
<head>
    ...
    <title>Sign In | SmartSorter AI</title>
...
<body class="bg-slate-950 text-slate-400 font-sans selection:bg-indigo-500 selection:text-slate-950 antialiased">
    ...
    <main class="relative min-h-screen w-full flex items-center justify-center px-6 pt-20 overflow-hidden">
        ...
        <div class="w-full max-w-md bg-slate-900/40 border border-slate-800 rounded-3xl p-8 md:p-10 backdrop-blur-sm relative z-10 shadow-2xl shadow-indigo-900/10">
            ...
            <div class="text-center mb-10">
                ...
                <p class="text-sm text-slate-400">Enter your credentials to access the console.</p>
            </div>
            ...
            <form method="POST" action="/login">
                ...
                <div class="flex items-center justify-between mb-8">
                    <label for="remember_me" class="inline-flex items-center cursor-pointer group">
                        <input id="remember_me" type="checkbox" class="w-4 h-4 rounded bg-slate-950 border-slate-700 text-indigo-600 focus:ring-indigo-500 focus:ring-offset-slate-900 accent-indigo-600" name="remember">
                        <span class="ms-2 text-sm text-slate-400 group-hover:text-white transition-colors">Remember me</span>
                    </label>

                    <a class="text-sm text-indigo-400 hover:text-indigo-300 font-semibold transition-colors" href="/forgot-password">
                        Forgot Password?
                    </a>
                </div>
    ...
    <footer class="absolute bottom-6 w-full text-center">
        <p class="text-[9px] font-mono uppercase tracking-[0.4em] text-slate-600">SmartSorter AI &bull; Secure Access</p>
    </footer>
